...
public class ViewAllPatientFrame extends javax.swing.JFrame {
    ...
    public ViewAllPatientFrame(JFrame obj){
        this();
        this.obj = obj;
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnBack2, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 420, 70, 30));
        ...
        jtView.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient ID", "Name", "Age", "Gender", "Marrital Status", "Address", "City", "Mobile No.", "Date", "OPD", "Doctor ID", "Status"
            }
        ) {
        ...
        jLabel4.setText("View All Patients");
    ...
    private void loadEmployeeDetails() {
        try{
            ...
            for(PatientPojo pat: patientList){
                ...
                obj[1]=(pat.getFirstName()+ " "+ pat.getLastName());
                obj[2]= pat.getAge();
                obj[9]=pat.getOpd();
                obj[3]=pat.getGender();
                obj[4]=pat.getMarriedStatus();
                obj[7]=pat.getDate();
                obj[5]=pat.getAddress();
                obj[6]=pat.getCity();
                obj[7]=pat.getMno();
                obj[8] = pat.getDate();
                obj[10]=pat.getDoctorId();

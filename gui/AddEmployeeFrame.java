...
public class AddEmployeeFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtEmpId.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        jPanel1.add(txtEmpId, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 460, 330, 40));
        ...
        jPanel1.add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 620, 200, 30));
    ...
    try{
        ...
        //can also set it from validate inputs.
    ...
    private boolean validateInputs() {
        if(txtEmpId.getText().trim().isEmpty() || txtEmpSal.getText().isEmpty()){
            return false;
        }
        return true;
    }
     private void generateNewId() {
        try{
            String empId=EmpDao.generateNextId();

 ...
 * @author LENOVO
 */
public class ViewAllAppointmentsFrame extends javax.swing.JFrame {
    
    private DefaultTableModel model;
    List<AppointmentPojo> appList;
    public ViewAllAppointmentsFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnBack2, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 410, 70, 30));
        ...
        jLabel4.setText("View Appointments Requests");
    ...
    private void jtViewMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtViewMouseClicked
        int rowIndex = this.jtView.getSelectedRow();
        AppointmentPojo app = appList.get(rowIndex);
        ConfirmAppointmentFrame cfm = new ConfirmAppointmentFrame(app);
        this.dispose();
        cfm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllAppointmentsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllAppointmentsFrame().setVisible(true);
            }
        });
    }
    ...
    private void loadAppointmentDetails() {
        try{
            appList = AppointmentDao.getAllAppointmentsByDoctorName(UserProfile.getUserName(), "REQUEST");
            if(appList.isEmpty()){

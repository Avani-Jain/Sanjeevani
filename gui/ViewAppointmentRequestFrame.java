 ...
 * @author LENOVO
 */
public class ViewAppointmentRequestFrame extends javax.swing.JFrame {
    
    private DefaultTableModel model;
    private List<AppointmentPojo> appList;
    
    public ViewAppointmentRequestFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTableAppointments.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient ID", "Patient Name", "opd", "Appointment Date", "Mobile Number"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAppointmentRequestFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAppointmentRequestFrame().setVisible(true);
            }
        });
    }

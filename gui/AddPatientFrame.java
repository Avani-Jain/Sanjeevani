...
public class AddPatientFrame extends javax.swing.JFrame {
    ...
    public AddPatientFrame(PatientPojo pat) {
        this();
        ...
        this.jcbGender.setSelectedItem(pat.getGender());
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 550, 200, 30));
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 460, 90, 30));
        ...
        jPanel1.add(txtOpd, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 340, 210, 30));
        ...
        jPanel1.add(txtPatientId, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 460, 210, 30));
...
//        System.out.println(patient.toString());
        JFrame op = new VerifyOtpFrame(patient, docname, 'a', this);
        op.setVisible(true);
        this.dispose();
...
//        System.out.println(patient.getAddress());
    ...
    private void getNewPatientId() {
        try{
            patid = PatientDao.getNewPatientId();
            this.txtPatientId.setText(patid);
            Date today = new Date();
